...
# Form implementation generated from reading ui file 'LogParserTable.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tvResult = QtWidgets.QTableWidget(self.centralWidget)
        self.tvResult.setObjectName("tvResult")
        self.tvResult.setColumnCount(0)
        self.tvResult.setRowCount(0)
        ...
        self.actionOpen_http_log = QtWidgets.QAction(MainWindow)
        self.actionOpen_http_log.setObjectName("actionOpen_http_log")
        self.menu_File.addAction(self.actionOpen_Log_File)
        self.menu_File.addAction(self.actionOpen_http_log)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnParse.setText(_translate("MainWindow", "Filter log file"))
        ...
        self.actionOpen_http_log.setText(_translate("MainWindow", "Open http log"))
